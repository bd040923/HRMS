-- Migration: add employee attribute columns for PIM module
-- Date: 2025-02-12
-- Usage: psql -U postgres -d arithwsie_hrms -f database/migrations/2025-02-12-add-employee-attributes.sql
