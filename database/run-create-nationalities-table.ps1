# PowerShell script to create nationalities table
# Run this script from the HR directory

$ErrorActionPreference = "Stop"

Write-Host "`n🔍 Creating Nationalities Table..." -ForegroundColor Cyan
...
# Path to SQL file
$sqlFile = "orangehrm\database\CREATE_NATIONALITIES_TABLE.sql"
...
Write-Host "`n✅ Done! The nationalities table should now exist." -ForegroundColor Green
