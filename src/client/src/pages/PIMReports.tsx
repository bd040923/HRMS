/**
 * arithwise_hrms PIM Reports Page
...
const PIMReports: React.FC = () => {
  const navigate = useNavigate();
  const [reports, setReports] = useState<Report[]>([
    { id: 1, name: 'All Employee Sub Unit Hierarchy Report', description: 'Shows organizational hierarchy', createdDate: '2024-01-15' },
    { id: 2, name: 'Employee Contact Info Report', description: 'Contact details of all employees', createdDate: '2024-01-16' },
    { id: 3, name: 'Employee Job Details', description: 'Job information and status', createdDate: '2024-01-17' },
    { id: 4, name: 'PIM Sample Report', description: 'Sample PIM data report', createdDate: '2024-01-18' },
  ]);
