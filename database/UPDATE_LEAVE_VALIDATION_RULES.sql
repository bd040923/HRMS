...
-- Drop and recreate the validation function with updated rules
...
BEGIN
    ...
    -- Calculate used days for the year (excluding current request if updating)
...
-- GRANT EXECUTE ON FUNCTION hrms_data.validate_leave_request(INTEGER, INTEGER, DATE, DATE, INTEGER) TO your_username;
