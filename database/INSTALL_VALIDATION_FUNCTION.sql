-- ============================================================================
-- INSTALL LEAVE VALIDATION FUNCTION - COMPLETE SCRIPT
-- ============================================================================
-- Run this ENTIRE file in PostgreSQL (copy-paste all at once)
-- ============================================================================
...
-- Create the complete function (DO NOT RUN PARTS OF THIS - RUN IT ALL)
...
SELECT 
    routine_name,
    'Function installed successfully!' as status
